...
An unbiased estimate does not guarantee lack of bias in nonlinear functions of that estimate: $\mathbb E\left[\hat\Sigma_0\right]=0 \centernot\implies  E\left[\varphi(\hat\Sigma_0\right)]=0$, where $\varphi$ is a nonlinear function. 
