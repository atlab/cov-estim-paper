...
\begin{Figure}
  ...
  \captionof{figure}{An example of 3D arrangement of recorded cells with color-coded orientation preference and edges indicating the network of positive and negative interactions (magenta) as revealed by the sparse+latent estimator. The latent units are not shown.}
